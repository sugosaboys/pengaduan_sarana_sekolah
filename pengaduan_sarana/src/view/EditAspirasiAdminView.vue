        ...
        >
          ...
          <div class="flex gap-2 w-full md:w-auto">
            <span class="w-full md:w-auto">
              ...
              <input
                v-model="AspirasiData.nis"
                type="text"
                placeholder="nis"
                class="bg-[#D9D9D9] w-full md:w-[200px] h-[50px] p-5 rounded text-black placeholder:text-black HelveticaMedium mb-5"
                disabled
              />
            </span>
            <span>
              ...
              <select
                v-model="AspirasiData.id_kategori"
                name="kategori"
                disabled
                class="bg-[#D9D9D9] w-full md:w-[200px] h-[50px] p-2 rounded text-black HelveticaMedium mb-5"
              >
          ...
          <span class="w-full md:w-auto">
            ...
            <textarea
              ...
              v-model.trim="AspirasiData.feedback"
              required
              class="bg-[#D9D9D9] w-full md:w-[400px] p-5 rounded text-black placeholder:text-black HelveticaMedium mb-5"
            ></textarea>
          </span>
