...
async function SubmitData() {
  ...
  try {
    ...
    toast.error(
      "Gagal menambahkan data, coba lagi!. Pastikan semua data terisi & Jangan duplikat!.",
    );
  }
}
</script>
  ...
  >
    <main class="flex justify-center items-center w-full xl:gap-10">
      <form class="w-full md:w-auto" @submit.prevent="SubmitData">
        ...
        >
          ...
          <input
            ...
            v-model.trim="KategoriData.ket_kategori"
            required
      ...
      <img
        ...
        loading="lazy"
        class="hidden xl:block w-[480px] h-[600px] object-cover rounded-[50px]"
      />
    </main>
  </section>
</template>
