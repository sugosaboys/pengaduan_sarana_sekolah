    ...
    <div class="relative flex flex-col w-full h-full overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span>
            <h4 class="HelveticaMedium">
              Kategori: {{ Aspirasi.ket_kategori }}
            </h4>
          ...
          <div
            class="flex justify-between items-center HelveticaBold w-full py-2"
          >
            <router-link
              v-if="Aspirasi.status === 'menunggu'"
              :to="`/edit/aspirasi/${Aspirasi.id_aspirasi}`"
              class="text-center"
              >✏️Edit</router-link
            >
            <button
